				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							margin-bottom:50px;"> Career GRASP</h1>
							...
							<?php
								...
								<?php else: ?>
									...
									<a class="main-button icon-button" href="faq.php">Get Started!</a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Career grasp</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Career grasp</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
						...
						<div class="feature">
							...
							<div class="feature-content">
								...
								<?php else: ?>
									...
									<a href=""><h4>Career Prediction</h4></a>
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="section-header">
							<h2 style="font-size: 35px;">About Career grasp</h2>
